...
input_image_path = r"C:\Users\Admin\Desktop\floppa.jpg"
output_image_path = r"C:\Users\Admin\Desktop\flopper.jpg"

# Call the function to convert the image to vectors
convert_to_vector(wt.resolve_path(input_image_path), wt.resolve_path(output_image_path))
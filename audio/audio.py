...
# %%
# Explore two files of the dataset
...
# %%
# Convert a wav file to a monochannel and 16k frequency audio 
...
# %%
# Define the paths to the positive and negative data of capuchinbirds
